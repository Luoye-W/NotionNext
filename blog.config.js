...
const BLOG = {
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || '🕶️Focus on AI/AR/VR glasses, exploring XR-related content, software, and usage tips.', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.xrnerd.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'xrnerd, ar glasses, ai glasses, xr glasses, vr glasses', // 网站关键词 英文逗号隔开
